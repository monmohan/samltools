...
func addSubject(assertionEl *etree.Element, requestId string, notOnOrAfter string) {
	...
	subjectConfData.CreateAttr("Recipient", "https://dev-ejtl988w.auth0.com/p/samlp/5aybgAvq")
...
func addConditions(assertionEl *etree.Element, notOnOrAfter string) {
	...
	aud.CreateText("urn:dev-ejtl988w.auth0.com")
}
...
func createSAMLResponse(assertion *etree.Element, requestId string) *etree.Element {
	doc := etree.NewDocument()
